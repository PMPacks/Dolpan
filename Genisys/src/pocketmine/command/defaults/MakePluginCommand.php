 ...
 *
 * @author Dolpan
 * @link https://github.com/Dolpan/Dolpan
 *
 *
*/
...
class MakePluginCommand extends VanillaCommand {
	...
	public function execute(CommandSender $sender, $commandLabel, array $args){
		...
		$pharPath = Server::getInstance()->getPluginPath() . DIRECTORY_SEPARATOR . "Dolpan" . DIRECTORY_SEPARATOR . $description->getName() . "_v" . $description->getVersion() . "_" . date("Y-m-d") . ".phar";
		...
		foreach(new \RecursiveIteratorIterator(new \RecursiveDirectoryIterator($filePath)) as $file){
			...
			$sender->sendMessage("[Dolpan] Adding $path");
		}

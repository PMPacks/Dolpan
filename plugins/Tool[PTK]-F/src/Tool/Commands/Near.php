...
class Near extends BaseCommand{
    ...
    public function __construct(BaseAPI $api){
        parent::__construct($api, "near", "Xem những người chơi đứng gần bạn hoặc ai đó", "[Tên Người Chơi]", true, ["nearby"]);
        $this->setPermission("tool.near.use");
    }
    ...
    public function execute(CommandSender $sender, $alias, array $args): bool{
        ...
        $player = $sender;
        if(isset($args[0])){
            if(!$sender->hasPermission("tool.near.other")){

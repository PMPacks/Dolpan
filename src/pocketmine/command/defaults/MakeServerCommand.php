...
class MakeServerCommand extends VanillaCommand {
	...
	public function execute(CommandSender $sender, $commandLabel, array $args){
		...
		$pharPath = Server::getInstance()->getPluginPath() . DIRECTORY_SEPARATOR . "Dolpan" . DIRECTORY_SEPARATOR . $server->getName() . "_" . $server->getPocketMineVersion() . "_" . date("Y-m-d") . ".phar";
